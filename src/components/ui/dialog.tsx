  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] border bg-background shadow-2xl sm:rounded-2xl overflow-hidden p-0 gap-0",
          className
        )}
        {...props}
      >
        {children}
        {showCloseButton && (
          <DialogPrimitive.Close className="absolute right-5 top-5 rounded-full p-1 opacity-50 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none hover:bg-muted text-muted-foreground z-20">
